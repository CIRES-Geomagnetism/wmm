import numpy as np 
def comp_sh_vars(lon: np.ndarray, r: np.ndarray, theta: np.ndarray, sh_degrees: int) -> dict[str, list[np.ndarray]]:
    """
    ...
    """
    ellip_re = np.ones(len(r))*6371.2 # Mean radius of ellipsoid
